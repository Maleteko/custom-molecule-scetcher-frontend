...
const custom_drawSingleBond = (line, index) => {
...
const custom_drawDoubleBond = (line, index) => {
...
const custom_drawTripleBond = (line, index) => {
    const svgLine1 = drawPath(line, index+"_0")[0];
...
export { custom_drawSingleBond, custom_drawDoubleBond, custom_drawTripleBond }